...
@interface STUNClient : NSObject <GCDAsyncUdpSocketDelegate>{
    ...
    @property NSString *stunIP;

- (void)requestPublicIPandPortWithUDPSocket:(GCDAsyncUdpSocket *)socket andPort:(int)port delegate:(id<STUNClientDelegate>)delegate;
